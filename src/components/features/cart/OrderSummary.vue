<template>
  <div class="p-8 border border-[#eaf0f0] dark:border-gray-800 rounded-xl bg-white dark:bg-zinc-900/50">
    ...
    <div class="mb-8">
      <label class="block text-xs font-bold uppercase tracking-wider text-[#5e8487] mb-2">Promo Code</label>
    ...
    <div class="mt-6 flex items-center justify-center gap-4">
      ...
      <p class="text-xs text-[#5e8487] font-medium text-center">Secure SSL Checkout</p>
    </div>
  </div>
</template>
